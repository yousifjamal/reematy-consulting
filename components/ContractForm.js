        ...
        {/**<div className='absolute bottom-0 top-0 left-0 right-0 h-[160vh] sm:h-[120vh] bg-black/70 z-[2]' />**/}
            <div className='flex-row'>
                <h1 className='text-5xl sm:text-5xl text-center text-white/75 mt-5 mb-10 font-serif'>CONTRACT US</h1>
                  <div className='w-[80vw] h-[75vh] sm:h-[82vh] sm:w-[30vw] font-serif bg-gradient-to-tl from-slate-900 to-gray-500 justify-start items-start  sm:mt-5 sm:ml-20 text-black/75 shadow-2xl rounded-2xl p-10'>
